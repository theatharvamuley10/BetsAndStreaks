...
export const abi = [
  ...
  },
  {
    ...
    outputs: [
      ...
      {
        internalType: "enum RPSGame.MatchStatus",
        name: "status",
        type: "uint8",
      },
      {
